...
def questionCreate(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            question.save()
            return redirect('/xion/list/')
    else:
        form = QuestionForm()
    context = {'form': form}
    return render(request, 'xion/question_form.html', context)
...
def answerModify(request, answer_id):
    ...
    if request.user != answer.author:
        messages.error(request, '수정권한이 없습니다')
        return redirect('xion:detail', question_id=answer.question.id)
    ...
    return render(request, 'xion/answer_form.html', context)
...
def comment_create_question(request, question_id):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    context = {'form': form}
    return render(request, 'xion/comment_form.html', context)
...
def comment_modify_question(request, comment_id):
    ...
    if request.user != comment.author:
        ...
        return redirect('xion:detail', question_id=comment.question.id)
...
def comment_create_answer(request, answer_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
            return redirect('xion:detail', question_id=comment.answer.question.id)
    else:
        form = CommentForm()
    context = {'form': form}
    return render(request, 'xion/comment_form.html', context)
