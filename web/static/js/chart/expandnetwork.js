...
var svg = d3v4.select("#popExpandZone").append("svg").attr("width", width).attr("height", height);

var imgs = svg.append("svg:image").attr("xlink:href", "/web/static/img/dashboard/expandNetwork-background.png").attr("x", 0).attr("y", 0).attr("width", "1880").attr("height", "880");
...
/*  node.attr("transform", function(d) {return "translate(" + d.x + "," + d.y + ")";})*/
    ...
    return "translate(" + (d.x < 80 ? dx = 80 : d.x > 1800 ? d.x = 1800 : d.x) + "," + (d.y < 80 ? d.y = 80 : d.y > 800 ? d.y = 800 : d.y) + ")"
  })
